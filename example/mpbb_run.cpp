...
int main(int argc, char** argv)
{
  ...
  int numthreads = atoi(argv[1]);
    ...
    string costmapimgfile = homedir+"/results/autoexploration/tmp/deutschemuseum/outimg00050.png" ;
    string gridmapimgfile = homedir+"/results/autoexploration/tmp/deutschemuseum/outimg00050.png" ;
    string mapinfofile    = homedir+"/results/autoexploration/tmp/deutschemuseum/mapinfo00050.txt";
